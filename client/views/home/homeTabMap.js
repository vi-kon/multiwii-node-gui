    ...
    if ($(e.target).attr('href') !== '#tab-map') {
        ...
        if (!tabInitialized) {
            GoogleMaps.init(
                ...
                function () {
                    var map, mapOptions, markerHome, markerMulticopter, multicopterIcon;
                    ...
                    markerMulticopter = new google.maps.Marker({
                                                                   map  : map,
                    ...
                    Tracker.autorun(function () {
                        if (tabActive && Session.get('mspData').rawGps.fix) {
                            markerMulticopter.setPosition({
                                                              lat: Session.get('mspData').rawGps.coord.latitude,
                                                              lng: Session.get('mspData').rawGps.coord.longitude
                                                          });
                        }
                    });
                }
